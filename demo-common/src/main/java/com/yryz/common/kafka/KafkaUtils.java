...
public class KafkaUtils {
    ...
    private static final String KAFKA_BOOTSTRAP_SERVERS = "192.168.64.130:9092";
...
/**
    ...
    static {
        ...
        props.put("bootstrap.servers", KAFKA_BOOTSTRAP_SERVERS);//服务器ip:端口号，集群用逗号分隔
        props.put("acks", "all");
        props.put("retries", 0);
