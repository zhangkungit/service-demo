...
import com.yryz.service.modules.id2.exception.IdGenerateException;
import com.yryz.service.modules.id2.service.BitsAllocator;
import com.yryz.service.modules.id2.service.IdGenerator;
import com.yryz.service.modules.id2.service.worker.WorkerIdAssigner;
import com.yryz.service.modules.id2.utils.DateUtils;
 ...
 * @author
 */
public class DefaultUidGenerator implements IdGenerator, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        LOGGER.info("IdGenerator Initialized bits(1, {}, {}, {}) for workerID:{}", timeBits, workerBits, seqBits, workerId);
    }
