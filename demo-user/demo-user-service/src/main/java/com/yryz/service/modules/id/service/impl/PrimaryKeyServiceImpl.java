...
import com.yryz.service.modules.id.common.GenIdConstant;
import com.yryz.service.modules.id.entity.KeyBuffer;
import com.yryz.service.modules.id.entity.KeyInfo;
import com.yryz.service.modules.id.entity.PrimaryKey;
import com.yryz.service.modules.id.exception.LoadPrimaryKeyException;
import com.yryz.service.modules.id.exception.UndeclaredPrimaryKeyException;
import com.yryz.service.modules.id.dao.persistence.PrimarykeyPersistenceDao;
import com.yryz.service.modules.id.service.PrimaryKeyService;
import com.yryz.service.modules.id.thread.ExpandThread;
import com.yryz.service.modules.id.thread.LoadPrepBuffThread;
...
public class PrimaryKeyServiceImpl implements PrimaryKeyService {
	...
	@Autowired
	private PrimarykeyPersistenceDao primaryKeyDao;
	...
	private PrimaryKey buildPrimaryKeyModel(String primaryKeyName) {
		...
		primaryKey.setCurrentValue(GenIdConstant.DEFAULT_PRIMARYKEY_CURRENT_VALUE);
